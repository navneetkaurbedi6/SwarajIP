<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IFFCODashboard.aspx.cs" Inherits="SwarajInsurancePortal.Views.IFFCO.IFFCODashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="../../Scripts/Custom/IFFCO/IFFCODashboard.js">
    </script>
        ...
        <div class="current_bg renewal_bg upload-bg">
            ...
            <div class="search">
                ...
                <select id="ddlDealer" class="select-search">
                    ...
                    <option value="Autofetch">Autofetch</option>
